...
classification, and thesis manual review — but **before** the final 726-work corpus merge.

They are included so you can reproduce the published corpus and figures in minutes without
...
| `clamps_theses_master_list.csv` | Thesis candidates; 29 with `manual_flag=y` in corpus |
